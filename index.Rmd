...
We assume certain familiarity with R and Bayesian Statistics. A good reference for the required background is @gelman2020raos, with Capter 17 on poststratification being particularly relevant. Additionally, multilevel models are covered in @gelman2006data (Part 2A) or @mcelreath2020statistical (Chapters 12 and 13).
